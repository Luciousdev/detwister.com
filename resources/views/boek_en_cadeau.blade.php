    ...
    <header class="header" id="header">
        <nav class="navbar containerNormal">
            ...
            <div class="menu" id="menu">
                <ul class="menu-inner">
                    @foreach (Statamic::tag('nav:boek_en_cadeau')->params(['include_home' => true])->sort('order')->fetch() as $index => $entry)
                        {{-- @if ($index > 0) --}}
...
@if(session('success') || session('error'))
    <section class="heroContainer" data-aos="fade-down" data-aos-duration="500" data-aos-offset="-100000" style="margin-top:0;">
        <div class="container-fluid col-xxl-8 px-4 py-5" style="margin-top:0;"></div>
        @else
                            ...
                            <div class="lc-block mb-3">
                                <div>
                                    <p class="lead">
                                        {{ $page->hero_text }}<br>
                                        @php
                                            if($page->typer_effect) {
                                                echo "<span id='typer'></span>";
                                            }
                                        @endphp
                                    </p>
                                </div>
            ...
            <div class="container-fluid footerContainer" data-aos="fade-down" data-aos-offset="-200" data-aos-delay="100">
                <div class="row" style="padding-top: 50px;">
                    <div class="col-md text-center my-auto">
                        ...
                        <ul>
                            @if ($footer_boek_en_cadeau->locatie_en_contact)
                                @foreach ($footer_boek_en_cadeau->locatie_en_contact as $locatie)
                                    <li><?php echo $locatie; ?></li>
                                @endforeach
                            @endif
                            <li><a href="tel:0207059907">020 - 7059907</a></li>
                    ...
                    <div class="col-md text-center my-auto socials">
                        <h3>Socials:</h3>
                        <ul>
                            <li><a href="{{ $footer_boek_en_cadeau->instagram_link }}" target="_blank"><img class="socialsLogo" src="/assets/logos/instagram.png"></a> <a href="{{ $footer_boek_en_cadeau->facebook_link }}" target="_blank"><img class="socialsLogo" src="/assets/logos/facebook.png"></a></li>
                        </ul>
                    </div>
                    <div class="col-md text-center my-auto openingsTijden">
                        <h3>Openingstijden:</h3>
                        <ul>
                            @if ($footer_boek_en_cadeau->openings_tijden)
                                @foreach($footer_boek_en_cadeau->openings_tijden as $openings_tijd)
